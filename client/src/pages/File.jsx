...
export default function File() {
  ...
  const handleDelete = async (id) => {
    ...
    try {
      ...
      const response = await fetch(`https://document-management-app-pwr7.onrender.com/api/deleteDocument/${id}`, {
        method: "DELETE",
        headers: {
  ...
  useEffect(() => {
    const fetchDocuments = async () => {
      ...
      try {
        const response = await fetch("https://document-management-app-pwr7.onrender.com/api/fetchAllDocument", {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
          },
